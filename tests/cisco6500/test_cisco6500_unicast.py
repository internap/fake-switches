...
class TestCisco6500Unicast(unittest.TestCase):
    __test__ = False
...
class TestCisco6500UnicastProtocolSSH(TestCisco6500Unicast):
    __test__ = True
...
class TestCisco6500UnicastProtocolTelnet(TestCisco6500Unicast):
    __test__ = True
